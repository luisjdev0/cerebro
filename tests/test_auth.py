"""Tests for token auth with scopes (`knowledgeos.auth`, plan_v2.md SS9).
...
from knowledgeos.api import create_app
from knowledgeos.auth import Principal, hash_token, generate_token
