#!/usr/bin/env python3
"""
Runner de la suite de evaluación de retrieval de KnowledgeOS.
...
def print_report(adapter_name: str, run_result: dict, agg: dict, include_superseded: bool) -> None:
    print()
    print("=" * 72)
    print(f"KnowledgeOS retrieval eval - adaptador: {adapter_name}")
    print(
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Corre la suite de evaluación de retrieval de KnowledgeOS.")
    parser.add_argument(
        "--adapter",
        required=True,
